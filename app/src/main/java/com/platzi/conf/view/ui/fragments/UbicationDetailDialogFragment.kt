...
class UbicationDetailDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvUbicationPlace.text = ubication.name
        tvUbicationAddress.text = ubication.address
        tvUbicationPhonePlace.text = ubication.phone
        tvUbicationWebsite.text = ubication.website

       tvUbicationPhonePlace.setOnClickListener {
        ...
        tvUbicationWebsite.setOnClickListener {
